...
with open(f'crawling_result/{date}/{date}_feastingathome_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_lazycatkitchen_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_lovingitvegan_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_minimalistbaker_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_myplate_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_pickuplimes_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_skinnytaste_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
with open(f'crawling_result/{date}/{date}_thecuriouschickpea_all.json', 'r', encoding='utf-8-sig') as file:
    raw_data = json.load(file)
...
# json 저장
output_path = f'crawling_result/{date}'
if not os.path.exists(output_path):
    os.mkdir(output_path)
df_all.to_json(f'crawling_result/{date}/{date}_crawling_recipe_all.json', orient='records')
